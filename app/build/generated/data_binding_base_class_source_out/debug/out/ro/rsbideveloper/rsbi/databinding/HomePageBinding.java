...
public final class HomePageBinding implements ViewBinding {
  ...
  @NonNull
  public final Button HomePageBtn;

  @NonNull
  public final ConstraintLayout HomePageLayout;

  private HomePageBinding(@NonNull ConstraintLayout rootView, @NonNull Button HomePageBtn,
      @NonNull ConstraintLayout HomePageLayout) {
  ...
  public static HomePageBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.Home_page_btn;
      Button HomePageBtn = rootView.findViewById(id);
      if (HomePageBtn == null) {
        break missingId;
      }

      ConstraintLayout HomePageLayout = (ConstraintLayout) rootView;

      return new HomePageBinding((ConstraintLayout) rootView, HomePageBtn, HomePageLayout);
    }
